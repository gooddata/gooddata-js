...
const CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS = `${CONTRACT_DATA_PRODUCT_SEGMENT}/domainsegments`;
const CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN = `${CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS}/:domainId`;
