...
If you have the visualization already prepared, you can skip this and continue with [embedding]({% post_url 2014-08-02-embedding-custom-visualization-into-dashboard %}).
